...
public class BicicletaService {
    ...
    private EstacionService estacionServ;
    ...
    public BicicletaDTO getBicicletaById (Integer id_bicicleta){
        ...
        return bicicleta.map(value -> new BicicletaDTO(value.getIdBicicleta(), value.getNumero_serie(), value.getTipo(), value.getEstado(), value.getidEstacion())).orElse(null);
    }
